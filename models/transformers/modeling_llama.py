...
# available at https://github.com/huggingface/transformers/blob/main/src/transformers/models/llama/modeling_llama.py.
#
...
from utils.module import split_heads, CausalLMPooling
...
class LlamaForVAEEncoder(LlamaPreTrainedModel):
    def __init__(self, config: LlamaConfig, vae_latent_size=32, pooling_strategy="last"):
...
class LlamaForVAEDecoder(LlamaPreTrainedModel):
